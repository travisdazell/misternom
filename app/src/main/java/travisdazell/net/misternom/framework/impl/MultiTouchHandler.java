...
/**
 * This class requires API Level 5, so we specify it in the annotation for the class
 * Otherwise, the compiler will complain if you set the minimum API Level to something lower than 5
